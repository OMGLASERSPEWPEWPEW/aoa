...
describe('SpectrumBar', () => {
  it('renders segments sorted descending', () => {
    ...
    const { container } = render(<SpectrumBar slices={slices} height={11} totalCards={20} />)
  ...
  it('caps at 7 segments', () => {
    ...
    const { container } = render(<SpectrumBar slices={slices} height={11} totalCards={50} />)
    const segments = container.querySelectorAll('[data-emotion]')
  ...
  it('shows early days mode when totalCards < 5', () => {
    ...
    render(<SpectrumBar slices={slices} height={11} totalCards={3} />)
  ...
  it('does not show early days when totalCards >= 5', () => {
    ...
    render(<SpectrumBar slices={slices} height={11} totalCards={10} />)
