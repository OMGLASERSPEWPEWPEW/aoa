...
export function AdminVenueDetail() {
  ...
  } = useEntityDetail('venue', id!)
  const { suggestions, accept, dismiss, dismissAll } = useCuratorSuggestions('venue', id!)
  ...
  const handleRelease = async (field: string) => {
    ...
    invalidateAfterOverride(qc, 'venue', id!)
  }
